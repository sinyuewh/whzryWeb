...
/**
 * Created by jinshouji on 2019/12/7.
 */
public class FileEncryptAndDecrypt {

    private static final String  key = "whzry13971135896";
    ...
    public static void encrypt(String fileUrl) throws Exception {
        ...
        String f2="【密文】"+path.substring(index+1);

        String destFile = path.substring(0, index)+"\\"+f2;
