...
/**
 * Created by jinshouji on 2018/11/28.
 */
public class SendMessageUtil {

    /*
    private static final String SMS_Url = "http://sms.webchinese.cn/web_api/";
    private static final String SMS_uid="liuyuhang1311";
    private static final String SMS_key="d41d8cd98f00b204e980"; */

    private static final String SMS_Url = "http://106.14.0.125:8088/smsGBK.aspx";
    private static final String SMS_uid="zyjd";
    private static final String SMS_key="336699";
     ...
     */
    public static Integer send1(String sendPhoneNum,String desc){
    ...
    public static String getMessage(Integer code){
        String message;
        if(code > 0 ) {
            message = "SMS-f发送成功！成功的发送" + code + "条短信";
        }else if(code == -1){
            message = "SMS-没有该用户账户";
        }else if(code == -2){
            message = "SMS-接口密钥不正确";
